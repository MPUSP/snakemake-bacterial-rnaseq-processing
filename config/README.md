...
| ----------------------------- | ---------------------------------------------------------------------------- |
| `results/correlation/`        | Correlation analysis of coverage generated by deepTools.                     |
| `results/coverage/`           | Global coverage summary generated by deepTools.                              |
| `results/deduplicated/`       | Aligned and UMI-deduplicated reads in BAM format, coverage in BigWig format. |
| `results/extracted_features/` | Features used for quantification in GFF format.                              |
| `results/fastp/`              | Adapter-trimmed and quality-filtered FASTQ files.                            |
| `results/fastqc/`             | Quality control reports for raw and processed reads (FastQC HTML files).     |
| `results/genome/`             | Downloaded or user-supplied reference genome and annotation files.           |
| `results/infer_experiment/`   | Inferred experiment information per sample.                                  |
...
| `results/umi_extract/`        | Temporary files generated during the workflow execution.                     |
